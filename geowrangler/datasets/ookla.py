...
# %% ../../notebooks/05_datasets_ookla.ipynb #19d8c85d-fad5-4cf2-8a00-d99f8276e4c8
import hashlib
import json
import os
import shutil
...
# %% ../../notebooks/05_datasets_ookla.ipynb #52a68395-fcaa-4114-87b2-a5f05f5356f1
OoklaFile = namedtuple("OoklaQuarter", ["type", "year", "quarter"])
DEFAULT_CACHE_DIR = "~/.cache/geowrangler"
OOKLA_QUADKEY_LEVEL = 16

# %% ../../notebooks/05_datasets_ookla.ipynb #84a30a6d-c28d-4be2-9325-ac7618d49a31
...
# %% ../../notebooks/05_datasets_ookla.ipynb #4865876c-69aa-4d51-adf4-734d298d20d8
...
# %% ../../notebooks/05_datasets_ookla.ipynb #c612bfab-4246-4b20-a44e-8e8efcae2818
...
# %% ../../notebooks/05_datasets_ookla.ipynb #e42707bb-ee16-4666-a7cd-6877aea4ec9c
...
# %% ../../notebooks/05_datasets_ookla.ipynb #14bb3c79-5d97-42a9-8457-046dd2b407b6
...
# %% ../../notebooks/05_datasets_ookla.ipynb #61c76533-3a3a-4dec-b98e-d0cbdcd26b69
...
# %% ../../notebooks/05_datasets_ookla.ipynb #6154b68d-331f-4bd5-a144-7219980433f8
...
# %% ../../notebooks/05_datasets_ookla.ipynb #c0b69fc5-2d54-48af-a9ff-61afe535ed4d
...
# %% ../../notebooks/05_datasets_ookla.ipynb #9c720b27-0194-4dcc-80c5-42a8bde7c32c
...
# %% ../../notebooks/05_datasets_ookla.ipynb #be695dbe-a999-4b6b-adc7-98b2837a001d
@patch
...
# %% ../../notebooks/05_datasets_ookla.ipynb #af3f5988-fc7e-4e96-a555-7c0a17638e84
@patch
...
# %% ../../notebooks/05_datasets_ookla.ipynb #a7ddb416-74c9-4579-9792-ea269ce19ad9
@patch
def load_type_year_data(
    ...
    for ookla_filename in sorted(os.listdir(type_year_cache_dir)):
        ...
        if ooklaFile:
            ...
            quarter_df = quarter_df.loc[quarter_df["quadkey"].isin(aoi_quadkeys),:].copy()
    ...
    if not return_geometry:
        ...
        df = gpd.GeoDataFrame(df, geometry=gpd.GeoSeries.from_wkt(df["tile"]), crs="epsg:4326")
        df.to_file(cached_file_path, driver="GeoJSON")
    return df

# %% ../../notebooks/05_datasets_ookla.ipynb #75432dda-099d-4aa1-b593-6a17303a124f
@patch
