...
# %% ../../notebooks/05_datasets_geofabrik.ipynb #8022060f-88b9-4d07-9e32-6ce9dce27e8d
import os
...
# %% ../../notebooks/05_datasets_geofabrik.ipynb #6e33cd05-ad3e-4f20-8902-b961c8e58ba3
DEFAULT_CACHE_DIR = "~/.cache/geowrangler"

# %% ../../notebooks/05_datasets_geofabrik.ipynb #57334510-4bc1-4a2b-a085-e839f456a8a9
@lru_cache(maxsize=None)
def load_geofabrik_data():
    return requests.get("https://download.geofabrik.de/index-v1-nogeom.json").json()

# %% ../../notebooks/05_datasets_geofabrik.ipynb #84a30a6d-c28d-4be2-9325-ac7618d49a31
...
# %% ../../notebooks/05_datasets_geofabrik.ipynb #cb6f3030-d40a-46c4-8685-9e5606a8798c
...
# %% ../../notebooks/05_datasets_geofabrik.ipynb #e382c869-35f0-40af-91a0-0385e236fe0a
...
# %% ../../notebooks/05_datasets_geofabrik.ipynb #422dd365-2772-44bc-a755-00269d576c34
...
# %% ../../notebooks/05_datasets_geofabrik.ipynb #fd0cb59e-7ee6-487c-bb8b-2e83cbd7f79b
...
# %% ../../notebooks/05_datasets_geofabrik.ipynb #d821382d-fd08-414f-b302-6941650fae6a
...
# %% ../../notebooks/05_datasets_geofabrik.ipynb #b9019916-7d44-40ce-93dc-dc736db0886c
@patch
def load_pois(
    self: OsmDataManager,
    region,
...
# %% ../../notebooks/05_datasets_geofabrik.ipynb #a19e6acb-a7e9-4735-8ffd-bc7027bc0f97
@patch
def load_roads(
    self: OsmDataManager,
    region,
