...
# %% ../../notebooks/14_datasets_nightlights.ipynb #aeac2510-3485-4198-b3eb-39c6d3ac2255
import gzip
import hashlib
import json
import os
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #a716a13b-7e17-41d9-95a9-c62adbe7059b
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #fbc0f313-579e-49b2-8da6-c320f4292068
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #81e322fd-151c-4112-b140-48e6faab49a6
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #41077511-7d4d-471f-b1ec-1ad07ff636b3
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #2ec45bd3-72f1-41f5-953a-38366b32eaf1
def download_url(
    url,
    dest=None,
    access_token=None,
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #ec1ca6af-ec03-40e4-9627-96e25440464d
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #a4fb594a-0e4d-4e18-b38f-f93520f3b664
def get_bounding_polygon(bounds, buffer=None):
    if buffer is None:
        return box(*bounds)
    return box(*bounds).buffer(buffer)

# %% ../../notebooks/14_datasets_nightlights.ipynb #66cd451e-c344-4596-a774-783cc437b755
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #5578bf2d-2242-490b-8356-bebf5a9b841b
URLFORM = {
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #08c652b0-4ad3-46c0-bb9a-38bee04c1493
def make_url(
    year,
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #c384e1fd-7a14-4134-85f6-aec81547b2e2
def make_clip_hash(
    year,
    bounds,
    viirs_data_type=EOG_VIIRS_DATA_TYPE.AVERAGE,
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #68bdc78b-7484-4e30-9ec8-ee269a89b902
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #ac9d1a2a-143c-4a22-83c0-4a7037720ed2
...
# %% ../../notebooks/14_datasets_nightlights.ipynb #8025ddc0-2af4-4fba-bd06-7657767fe0d9
