...
# %% ../notebooks/02_vector_zonal_stats.ipynb #4726b379-56e7-43d7-b3dc-ba2858f16773
GEO_INDEX_NAME = "__GeoWrangleer_aoi_index"

# %% ../notebooks/02_vector_zonal_stats.ipynb #b2133259-3fa9-4f2e-82e3-d632f9c5e35a
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #7e915eb6-5270-4022-abbb-8e061ce7bcb9
def _fix_agg(
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #c801e5ae-9163-48e5-a5a8-96b5b40879b9
def _check_agg(
    agg: Dict[str, Any],  # A dict containing at the minimum a 'func' key
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #69b95df7-b6fc-46eb-904c-d580fe997dd1
def _validate_aggs(
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #c1d7c5fb-acb0-418a-b314-2d41e1fee7c9
def _validate_aoi(
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #e72a2ea2-7163-4593-9310-b96ddfab3f67
def _expand_aggs(
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #894131e2-31bd-4a65-95a0-70ac253b39c7
def _build_agg_args(
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #a9dea21e-fbc9-4121-9ad0-0f3d08f05e3a
def _prep_aoi(
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #151f01ac-750a-4e4b-b9bc-3072ba0e9dfd
def _fillnas(
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #b1768cc6-e4fa-432d-94a7-12d6fb2bb4dc
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #ab5241e1-fda3-4dee-88e0-909a2bd7d352
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #6898c76e-6f15-46fd-8778-2dc0879ede45
tms = morecantile.tms.get("WebMercatorQuad")  # Tile Matrix for Bing Maps

# %% ../notebooks/02_vector_zonal_stats.ipynb #3b327894-cc81-4f45-b6bf-d31bda9375ff
def get_quadkey(geometry, zoom_level):
    return tms.quadkey(tms.tile(geometry.x, geometry.y, zoom_level))

# %% ../notebooks/02_vector_zonal_stats.ipynb #df76e302-2c98-40e2-a2d0-3ddcfe49bd7c
def compute_quadkey(
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #b38dfa9d-2f86-4b7e-a33f-970a033a4dff
...
# %% ../notebooks/02_vector_zonal_stats.ipynb #7c5bfb49-371d-439d-8dab-8ac9452edc94
