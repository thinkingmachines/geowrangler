# AUTOGENERATED! DO NOT EDIT! File to edit: notebooks/notebooks/00_validation.ipynb (unless otherwise specified).

__all__ = ['ValidationError', 'BaseValidator', 'OrientationValidator', 'CrsBoundsValidator',
           'SelfIntersectingValidator', 'NullValidator', 'GeometryValidation']
